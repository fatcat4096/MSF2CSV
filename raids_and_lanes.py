...
tables['thunderstrike'] = { 'name': 'Thunderstrike Raid',
					...
					'lanes':[ [
							{'traits': ['Harbingers'], 'subsections':[	{'meta': VIGILANTE,  'label':'Vigilantes<br>(Harbingers)', 'inc_avail': True},
																		...
																		{'meta': F4MCUTEAM,  'label':'Fantastic Four<br>(Harbingers)', 'inc_avail': True},
																		{'meta': TBOLTS,     'label':'Thunderbolts<br>(Harbingers)'}]},
							{'traits': ['Conqueror'], 'subsections':[	{'meta': INSIDIOUS,  'label':'Insidious Six<br>(Conquerors)', 'inc_avail': True},
																		{'meta': BRIMSTONE,  'label':'Brimstone<br>(Conquerors)'},
																		{'meta': ['Quasar'], 'label':'Quasar<br>(Conquerors)'},{},
																		{'meta': F4MCUTEAM,  'label':'Fantastic Four<br>(Conquerors)', 'inc_avail': True},
...
#							{'traits': ['BlackOrder'], 'meta': ['Corvus Glaive', 'Cull Obsidian', 'Ebony Maw', 'Proxima Midnight', 'Thanos']},
							...
							{'traits': ['Cabal']},
							{'traits': ['Champions'], 'meta': CHAMPIONS},
							{'traits': ['DaringWarriors'], 'meta': ['Daredevil', 'Jessica Jones', 'Night Thrasher', 'Speedball', 'Eclipse']},
#							{'traits': ['Darkhold']},
#							{'traits': ['DarkHunter']},
#							{'traits': ['Deathseed']},
#							{'traits': ['Eternal']},
