...
tables['spec_ops'] = { 'name': 'Spec Ops',
					...
					'span': True,
					'lanes':[ [ 
							{'traits': ['Mission 1'], 'min_yel' : 3, 'show_reqs': True, 'meta': ["Old Man Logan", "Hank Pym", "Sasquatch", "Guardian", "Daken", "Iron Patriot"] },
							{'traits': ['Mission 2'], 'min_yel' : 5, 'show_reqs': True, 'meta': ["Black Bolt", "Black Panther (Shuri)", "Northstar", "Pandapool", "The Leader", "Sunfire"] },
							{'traits': ['Mission 3'], 'min_yel' : 7, 'show_reqs': True, 'meta': ["Iron Man", "Deathpool", "Namor", "Mister Fantastic", "Deadpool", "Wolverine"] },
							{'traits': ['Mission 4'], 'min_tier':15, 'show_reqs': True, 'meta': ["Cosmic Ghost Rider", "Spider-Slayer", "Spider-Man (Noir)", "Silver Surfer", "Moon Knight", "Venom"] },
							{'traits': ['Mission 5'], 'min_tier':17, 'show_reqs': True, 'meta': ["Super Skrull", "Black Cat", "Peter B. Parker", "Red Goblin", "Kraven the Hunter", "Ultimus"] },
							{'traits': ['Mission 6'], 'min_red' : 6, 'show_reqs': True, 'meta': ["Nova", "Doctor Octopus", "Gorr", "Spider-Man (Pavitr)", "Mysterio", "Carnage"] },
							{'traits': ['Mission 7'], 'min_tier':19, 'show_reqs': True, 'meta': ["Green Goblin (Classic)", "Thanos (Endgame)", "Peni Parker", "Void Knight", "Spider-Man (Big Time)", "Vahl"] },
							{'traits': ['Mission 8'], 'min_red' : 8, 'show_reqs': True, 'meta': ["Gladiator", "Gwenom", "Lizard", "Kang the Conqueror", "Ghost-Spider", "Vulture"] },
							],[
							{'traits': ['Mission 1'], 'min_yel' : 3, 'show_reqs': True, 'meta': ["Captain Britain", "Thanos (Endgame)", "Gorr", "Black Panther (Shuri)", "Peni Parker", "Peter B. Parker"] },
							{'traits': ['Mission 2'], 'min_yel' : 5, 'show_reqs': True, 'meta': ["Gladiator", "Hank Pym", "Spider-Man (Pavitr)", "Starbrand", "Mister Fantastic", "Ultimus"] },
							{'traits': ['Mission 3'], 'min_yel' : 7, 'show_reqs': True, 'meta': ["Black Bolt", "Cosmic Ghost Rider", "Black Knight", "Spider-Man (Noir)", "Silver Surfer", "Ghost-Spider"] },
							{'traits': ['Mission 4'], 'min_tier':15, 'show_reqs': True, 'meta': ["Doctor Doom", "Juggernaut (Zombie)", "Omega Sentinel", "Northstar", "Daken", "Sunspot"] },
							{'traits': ['Mission 5'], 'min_tier':17, 'show_reqs': True, 'meta': ["Rogue", "Sentinel", "Ares", "Forge", "Sunfire", "Deathpool"] },
							{'traits': ['Mission 6'], 'min_red' : 6, 'show_reqs': True, 'meta': ["Iron Man (Zombie)", "Pandapool", "Iron Patriot", "Cyclops", "Scientist Supreme", "Wolverine"] },
							{'traits': ['Mission 7'], 'min_tier':19, 'show_reqs': True, 'meta': ["Apocalypse", "Old Man Logan", "Nimrod", "Sasquatch", "The Leader", "Gambit"] },
							{'traits': ['Mission 8'], 'min_red' : 8, 'show_reqs': True, 'meta': ["Guardian", "Nightcrawler", "Agatha Harkness", "Lady Deathstrike", "Namor", "Deadpool"] },
							],[
							{'traits': ['Mission 1'], 'min_yel' : 3, 'show_reqs': True, 'meta': ["Omega Sentinel", "Nimrod", "Northstar", "Pandapool", "Gwenom", "Deadpool"] },
							{'traits': ['Mission 2'], 'min_yel' : 5, 'show_reqs': True, 'meta': ["Old Man Logan", "Sentinel", "Sasquatch", "Red Goblin", "Deathpool", "Wolverine"] },
							{'traits': ['Mission 3'], 'min_yel' : 7, 'show_reqs': True, 'meta': ["Guardian", "Daken", "Void Knight", "Sunfire", "Lady Deathstrike", "Scientist Supreme"] },
							{'traits': ['Mission 4'], 'min_tier':15, 'show_reqs': True, 'meta': ["Black Cat", "Iron Man", "Peter B. Parker", "Starbrand", "Quicksilver", "Ultimus"] },
							{'traits': ['Mission 5'], 'min_tier':17, 'show_reqs': True, 'meta': ["Green Goblin (Classic)", "Captain Britain", "Gorr", "Spider-Man (Pavitr)", "Spider-Man (Big Time)", "Captain Carter"] },
							{'traits': ['Mission 6'], 'min_red' : 6, 'show_reqs': True, 'meta': ["Super Skrull", "Black Bolt", "Ares", "Cosmic Ghost Rider", "Sunspot", "Silver Surfer"] },
							{'traits': ['Mission 7'], 'min_tier':19, 'show_reqs': True, 'meta': ["Mephisto", "Nova", "Gladiator", "Black Panther (Shuri)", "Black Knight", "Nightcrawler"] },
							{'traits': ['Mission 8'], 'min_red' : 8, 'show_reqs': True, 'meta': ["Apocalypse", "Thanos (Endgame)", "Hank Pym", "Peni Parker", "Forge", "Captain America"] },
							],[
							{'traits': ['Mission 1'], 'min_yel' : 3, 'show_reqs': True, 'meta': ["Man-Thing", "Oath", "Blade", "Sentinel", "Agatha Harkness", "Ultimus"] },
							{'traits': ['Mission 2'], 'min_yel' : 5, 'show_reqs': True, 'meta': ["Doctor Doom", "Captain Britain", "Omega Sentinel", "Nimrod", "Thanos (Endgame)", "Guardian"] },
							{'traits': ['Mission 3'], 'min_yel' : 7, 'show_reqs': True, 'meta': ["Dormammu", "Hank Pym", "Black Panther (Shuri)", "Northstar", "Peni Parker", "Moon Knight"] },
							{'traits': ['Mission 4'], 'min_tier':15, 'show_reqs': True, 'meta': ["Archangel", "Phoenix", "Scarlet Witch (Zombie)", "Spider-Man (Pavitr)", "Spider-Weaver", "Cyclops"] },
							{'traits': ['Mission 5'], 'min_tier':17, 'show_reqs': True, 'meta': ["Rogue", "Morgan Le Fay", "Juggernaut (Zombie)", "Gladiator", "Sunspot", "X-23"] },
							{'traits': ['Mission 6'], 'min_red' : 6, 'show_reqs': True, 'meta': ["Odin", "Old Man Logan", "Red Hulk", "Peter B. Parker", "Red Goblin", "Nightcrawler"] },
							{'traits': ['Mission 7'], 'min_tier':19, 'show_reqs': True, 'meta': ["Super Skrull", "Gorr", "Gwenom", "Forge", "Deathpool", "Wolverine"] },
							{'traits': ['Mission 8'], 'min_red' : 8, 'show_reqs': True, 'meta': ["Iron Man (Zombie)", "Sasquatch", "Void Knight", "Vahl", "Sunfire", "Gambit"] },
							],[
							{'traits': ['Mission 1'], 'min_yel' : 3, 'show_reqs': True, 'meta': ["Scarlet Witch (Zombie)", "Gladiator", "Guardian", "Sunfire", "Silver Surfer", "Wolverine"] },
							{'traits': ['Mission 2'], 'min_yel' : 5, 'show_reqs': True, 'meta': ["Iron Man (Zombie)", "Gorr", "Ares", "Northstar", "Daken", "Deadpool"] },
							{'traits': ['Mission 3'], 'min_yel' : 7, 'show_reqs': True, 'meta': ["Old Man Logan", "Juggernaut (Zombie)", "Thanos (Endgame)", "Sasquatch", "Pandapool", "Ultimus"] },
							{'traits': ['Mission 4'], 'min_tier':15, 'show_reqs': True, 'meta': ["Man-Thing", "Peni Parker", "Void Knight", "Ghost Rider (Robbie)", "Lady Deathstrike", "Mysterio"] },
							{'traits': ['Mission 5'], 'min_tier':17, 'show_reqs': True, 'meta': ["Apocalypse", "Oath", "Gwenom", "Spider-Slayer", "Quicksilver", "Scientist Supreme"] },
							{'traits': ['Mission 6'], 'min_red' : 6, 'show_reqs': True, 'meta': ["Green Goblin (Classic)", "Captain Britain", "Sentinel", "Hank Pym", "Black Panther (Shuri)", "Venom"] },
							{'traits': ['Mission 7'], 'min_tier':19, 'show_reqs': True, 'meta': ["Blade", "Omega Sentinel", "Peter B. Parker", "Cosmic Ghost Rider", "Red Goblin", "Vulture"] },
							{'traits': ['Mission 8'], 'min_red' : 8, 'show_reqs': True, 'meta': ["Doctor Octopus", "Nimrod", "Spider-Man (Pavitr)", "Deathpool", "Moon Knight", "Carnage"] }
							] ],
