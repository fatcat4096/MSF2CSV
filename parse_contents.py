...
def parse_char_data(CHAR_DATA, char_list, char_lookup, portraits, traits):
	...
	for useless in ['AnniversaryElite', 'Archenemy', 'Couples', 'Chargeable', 'Energized', 'Exposed', 'Juneteenth', 'KnowhereHeist', 'KnullChallengers', 'MarvelMoms', 'PoolPals', 'SpiritofVengeance', 'StrikeAsset', 'Ultron', 'United', 'Wave1', 'Wave1Avenger', 'WebSlinger']:
