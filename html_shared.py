...
def translate_name(value):
	TRANSLATE_NAME = {	"City Hero": "City<br>Hero",
						...
						"AmazingAvengers": "Amazing<br>Avengers",
						...
						"BestBuddies": "Best<br>Buddies",
						"BestAvengerBuddies": "Best Avenger<br>Buddies",
						"BestMutantBuddies": "Best Mutant<br>Buddies",
						"BestSpiderBuddies": "Best Spider<br>Buddies",
						"BestVillainBuddies": "Best Villian<br>Buddies",
						...
						"TimelessEternal": "Timeless<br>Eternals",
						...
						"Daredevil (Modern)":"Daredevil<br>(Modern)",
